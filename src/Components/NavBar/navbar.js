  ...
  return (
    <nav className="navbar">
      ...
      <div className="desktopMenu">
           ...
           <Link activeClass='active'to ='resume' spy={true} smooth={true} offset={-500} duration={500} className="desktopMenuListItem">Resume</Link>
    ...
    const yOffset = -50;
    const yPosition = contactPageElement.getBoundingClientRect().top + window.pageYOffset + yOffset;
    window.scrollTo({ top: yPosition, behavior: 'smooth' });
      ...
      <div className="navMenu" style={{display: showMenu? 'flex':'none'}}>
           ...
           <Link activeClass='active'to ='resume' spy={true} smooth={true} offset={-500} duration={500} className="desktopMenuListItem" onClick={()=>setShowMenu(false)} >Resume</Link>
           <Link activeClass='active'to ='contactPage' spy={true} smooth={true} offset={-500} duration={500} className="desktopMenuListItem" onClick={()=>setShowMenu(false)} >Contact Me</Link>
    </div>
    </nav>
  )
}
